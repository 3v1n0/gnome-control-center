...
connect_ip4_page (CEPageIP4 *page)
{
        ...
        radios[0] = GTK_TOGGLE_BUTTON (gtk_builder_get_object (CE_PAGE (page)->builder, "radio_automatic"));
        radios[1] = GTK_TOGGLE_BUTTON (gtk_builder_get_object (CE_PAGE (page)->builder, "radio_local"));
        radios[2] = GTK_TOGGLE_BUTTON (gtk_builder_get_object (CE_PAGE (page)->builder, "radio_manual"));
        radios[3] = GTK_TOGGLE_BUTTON (gtk_builder_get_object (CE_PAGE (page)->builder, "radio_disabled"));

        g_signal_connect (radios[0], "toggled", G_CALLBACK (method_changed), page);
        ...
        case IP4_METHOD_LINK_LOCAL:
                gtk_toggle_button_set_active (radios[1], TRUE);
                break;
        case IP4_METHOD_MANUAL:
                gtk_toggle_button_set_active (radios[2], TRUE);
                break;
        case IP4_METHOD_DISABLED:
                gtk_toggle_button_set_active (radios[3], TRUE);
                break;
        default:
                break;
        }
